...
<div class="w">
  <div>
    ...
    <div class="item">
      ...
      <div class="itemlist">
        <ul>
          <li v-for="(item, index) in  getSearchList" :key="item.id" @click="goDetail(item)">
            <el-image
...
export default {
  ...
  methods: {
   ...
   async getData(pageNum = 1, pageSize = 10) {
      ...
      await this.$store.dispatch('getSearchInfo', {pageNum,pageSize,goods_name});
  ...
  computed: {
    ...
    ...mapGetters(["getSearchList","getSearchTotal"]),
